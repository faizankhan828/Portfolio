...
export default function Contact({ data }: ContactProps) {
  ...
  const [formState, setFormState] = useState<FormData>({ name: '', email: '', message: '' });
  ...
  return (
    <section id="contact" className="section-container relative py-32 px-4 overflow-hidden" aria-label="Contact section">
        ...
        <div className="grid md:grid-cols-5 gap-8">
          ...
          >
            <div className="glass rounded-3xl p-8">
              <h3 className="text-2xl font-bold text-neutral-900 dark:text-white mb-4 font-['Space_Grotesk']">
                Contact Info
              </h3>
              ...
              <motion.a
                ...
                className="flex items-center gap-4 p-4 glass-light rounded-2xl hover:border-primary-400/40 border border-primary-400/20 transition-all group mb-6"
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-semibold text-neutral-900 dark:text-white">{data.email}</p>
                </div>
              </motion.a>
                ...
                <div className="flex gap-3">
                  {data.social.map((social) => (
                    <motion.a
                      ...
                      className="w-12 h-12 glass-light rounded-xl flex items-center justify-center hover:border-primary-400/40 border border-primary-400/20 transition-all group"
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <form onSubmit={handleSubmit} className="glass rounded-3xl p-8 md:p-10 relative" noValidate aria-label="Contact form">
              ...
              <div className="space-y-6 relative">
                <div>
                  ...
                  <motion.input
                    ...
                    className={`w-full px-4 py-3 glass-light rounded-xl border-2 transition-all disabled:opacity-50 text-neutral-900 dark:text-white placeholder-neutral-400 ${
                      errors.name 
                ...
                <div>
                  ...
                  <motion.textarea
                    ...
                    className={`w-full px-4 py-3 glass-light rounded-xl border-2 transition-all disabled:opacity-50 resize-none text-neutral-900 dark:text-white placeholder-neutral-400 ${
                      errors.message 
                        ? 'border-red-400 focus:border-red-500' 
                        : 'border-primary-400/20 focus:border-primary-400'
                    }`}
                ...
                <motion.button
                  type="submit"
                  disabled={submitStatus === 'submitting'}
                  whileHover={shouldReduceMotion || submitStatus === 'submitting' ? {} : { scale: 1.02, boxShadow: "0 20px 40px rgba(14, 165, 233, 0.3)" }}
                  whileTap={shouldReduceMotion || submitStatus === 'submitting' ? {} : { scale: 0.98 }}
                  className="w-full px-6 py-4 bg-gradient-to-r from-primary-500 to-accent-500 text-white rounded-xl font-bold shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed shimmer"
                >
