          ...
          <div className="flex items-center justify-between h-16 sm:h-20 md:h-24 lg:h-28">
            ...
            >
              <button
                ...
                className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 via-blue-500 to-violet-600 font-['Space_Grotesk'] focus:outline-none focus:ring-4 focus:ring-cyan-400/50 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-neutral-900 rounded-2xl px-3 sm:px-4 md:px-6 py-2 sm:py-2.5 md:py-3 hover:scale-110 transition-transform"
                style={{
              ...
              {navItems.map((item) => {
                ...
                return (
                  <motion.button
                    ...
                    className={`relative px-4 lg:px-6 xl:px-10 py-2 lg:py-3 xl:py-4 text-base lg:text-lg xl:text-xl font-bold rounded-2xl transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-cyan-400/50 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-neutral-900 ${
                      isActive
