...
export default function Skills({ data }: SkillsProps) {
  ...
  return (
    <section id="skills" className="section-container relative py-32 px-4 overflow-hidden" aria-labelledby="skills-heading">
      {/* Decorative gradient orbs */}
      <motion.div
        className="absolute top-40 left-20 w-96 h-96 bg-primary-400/20 rounded-full blur-3xl"
          ...
          >
            {data.map((skill, index) => {
              ...
              return (
                ...
                >
                  <motion.div
                    className="glass-light rounded-2xl p-4 md:p-6 hover:scale-110 transition-all duration-300 cursor-pointer group relative min-w-[120px] md:min-w-[140px]"
                  ...
                  >
                    ...
                    <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-primary-500/0 to-accent-500/0 group-hover:from-primary-500/20 group-hover:to-accent-500/20 transition-all duration-300 blur-xl" />
                    
                    <div className="relative text-center">
                      <h3 className="text-sm md:text-base font-bold text-neutral-900 dark:text-white mb-2 font-['Space_Grotesk']">
                        {skill.name}
                      </h3>
